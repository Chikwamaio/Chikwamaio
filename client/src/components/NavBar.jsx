  ...
  const handleOpenMenu = () =>
  {
    ...
    return(
      ...
      <div className="text-3xl absolute right-8 top-4 cursor-pointer">
        ...
        <li className="cursor-pointer md:mt-0 mt-2 mr-3 hover:text-fuchsia-700">Cashpoints</li>
        <li className="cursor-pointer md:mt-0 mt-2 mr-3 hover:text-fuchsia-700">DAO</li>
